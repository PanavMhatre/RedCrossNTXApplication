            ...
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form action="#" class="space-y-8">
                    <div>
                        ...
                        <input type="email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-red-700 text-sm rounded-lg block w-full p-2.5 " placeholder="name@flowbite.com" required/>
                    </div>
                    <div>
                        <label for="subject" class="block mb-2 text-md font-medium text-white">Subject</label>
                    ...
                    <div class="sm:col-span-2">
                        <label for="message" class="block mb-2 text-md font-medium text-white">Your message</label>
                    ...
                    <button type="submit" class="py-3 px-5 text-md font-medium text-center text-white rounded-lg bg-primary-700 border-2 border-white sm:w-fit hover:bg-white hover:text-red-700 duration-300 ">Send message</button>
                </form>
            </div>
        </section>
      </div>
